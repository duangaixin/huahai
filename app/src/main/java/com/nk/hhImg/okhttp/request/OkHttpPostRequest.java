package com.nk.hhImg.okhttp.request;
...
/**
 * Created by wuxin on 2015/12/2.
 */
public class OkHttpPostRequest<T> extends OkHttpRequest
{
    ...
    public OkHttpPostRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, MediaType mediaType, String content, byte[] bytes, File file)
    {
